...
def initiate():
    ...
    # Tworzymy tylko nowe CarMake, jeśli nie istnieją
    ...
    # Stworzenie listy instancji CarModel
    car_model_data = [
    ...
    # Użycie bulk_create do efektywnego dodania modeli samochodów
    car_model_instances = [CarModel(**data) for data in car_model_data]
